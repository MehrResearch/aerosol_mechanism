...
1. Download and extract the [paper dataset](https://zenodo.org/records/17601125/files/paper_dataset.tar.gz?download=1) from Zenodo. The following commands can be used on Linux or macOS to automate this. On Windows you can manually download the file and use 7zip or similar to extract the `.tar.gz` archive.
